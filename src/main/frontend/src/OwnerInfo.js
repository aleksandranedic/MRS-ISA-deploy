...
function OwnerInfo({name, rate, bio, email, phoneNum, address, profileImg, category, points, penalty}) {
    ...
    return (
        <div className="d-flex align-items-center justify-content-center ps-2 m-5" id="info">
            ...
            <div className='d-flex flex-column align-items-center justify-content-center ps-2 m-0 w-100'
                 style={{width: "85%"}}>
                <div className='h-75 w-100'>
                    <div className='pt-3 ps-0 d-flex justify-content-between' style={{width: "100%"}}>
                        <div className="d-flex align-items-center justify-content-around infoDiv"
                             style={{width: "100%"}}>
                            <div className="d-flex flex-column justify-content-start">
                                <h2 className="fw-normal p-0 m-0 pt-2">{name}</h2>
                                <div className="d-flex align-items-center">
                                    <p className="fw-bold m-0 mt-1 p-0"> {rate} </p>
                                    <StarRatings rating={rate} starDimension="17px" starSpacing="1px"
                        ...
                        <ProfileInfo icon={BsGeoAlt} label={"Adresa"}
                                     text={address.street + " " + address.number + ", " + address.place + ", " + address.country}/>
                    </div>
                </div>
                    ...
                    <div className="mt-4 ms-3 w-50 d-flex align-items-center">
                        ...
                        <div className="d-flex w-25 align-items-center">
                            ...
                            {typeof penalty != "undefined" &&
                                <div className="d-flex">
                                    <MdDoNotDisturbOn className="pe-2 ms-3"
                                                      style={{width: "4vh", height: "4vh", color: "#ff4242"}}/>
                                    {penalty}
